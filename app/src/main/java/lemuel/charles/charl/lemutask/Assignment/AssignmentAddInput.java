...
public class AssignmentAddInput extends AppCompatActivity implements TodoTimePicker.myOnCompleteListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.cancel:
                finish();
                Toast.makeText(AssignmentAddInput.this, "Canceled", Toast.LENGTH_SHORT).show();
                break;
            default:
    ...
    public boolean adddata() {
        ...
        if (calender.getTimeInMillis() >= calender_compare.getTimeInMillis()) {
            ...
            if (isins) {
                Toast.makeText(AssignmentAddInput.this, "Success" + hour + ":" + minute, Toast.LENGTH_SHORT).show();
            } else
                Toast.makeText(AssignmentAddInput.this, "Not Saved", Toast.LENGTH_SHORT).show();
...
/////////////////////////
    ...
    public boolean adddatatime() {
        ...
        if (isins) {
            Toast.makeText(AssignmentAddInput.this, "Success saved", Toast.LENGTH_SHORT).show();
        } else
            Toast.makeText(AssignmentAddInput.this, "Not Saved data", Toast.LENGTH_SHORT).show();
