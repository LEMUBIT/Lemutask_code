...
private DatePickerDialog.OnDateSetListener datelistener=new DatePickerDialog.OnDateSetListener()
{
    ...
    public boolean adddata()
    {
        ...
        if(calender.getTimeInMillis()>=calender_compare.getTimeInMillis()) {
            ...
            boolean isins = sqlht.insertAssignmentdata(wktitle.getText().toString(), wkdetail.getText().toString(), istimed,time.getText().toString(), String.valueOf(pday), String.valueOf(pmonth), String.valueOf(pyear));
            if(isins)
            {
