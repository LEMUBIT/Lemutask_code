...
/**
 * Created by charles on 16/05/2017.
 */

public class NextSevenDays_adapter extends CursorAdapter {

    public NextSevenDays_adapter(Context context, Cursor c, boolean autoRequery) {
