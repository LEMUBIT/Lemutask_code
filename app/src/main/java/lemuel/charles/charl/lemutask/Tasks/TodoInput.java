...
import lemuel.charles.charl.lemutask.Tasks.Service.Todo_alarm;

public class TodoInput extends AppCompatActivity implements TodoTimePicker.myOnCompleteListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alarmint = new Intent(TodoInput.this, Todo_alarm.class);
...
//
    ...
    private DatePickerDialog.OnDateSetListener datelistener = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
            ...
            pday = dayOfMonth;
            datebtn.setText(pday + "/" + pmonth + "/" + pyear);
            //  Toast.makeText(TodoInput.this,"This is the year "+pyear+" and the month "+pmonth+"
...
/////////////
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.cancel:
                finish();
                Toast.makeText(TodoInput.this, "Not Saved", Toast.LENGTH_SHORT).show();
                break;
            default:
...
//pending intent
            ...
            pendingalarm = PendingIntent.getBroadcast(TodoInput.this, 0, alarmint, PendingIntent.FLAG_UPDATE_CURRENT);
            ...
            if (isins) {
                Toast.makeText(TodoInput.this, "Success" + hour + ":" + minute, Toast.LENGTH_SHORT).show();
            } else
                Toast.makeText(TodoInput.this, "Not Saved", Toast.LENGTH_SHORT).show();
    ...
    public boolean adddatanotime() {
        ...
        if (calender.getTimeInMillis() >= calender_compare.getTimeInMillis()) {
            ...
            if (isins) {
                Toast.makeText(TodoInput.this, "Success", Toast.LENGTH_SHORT).show();
            } else
                Toast.makeText(TodoInput.this, "Not Saved", Toast.LENGTH_SHORT).show();
    ...
    //implements onComplete form TodoTimePicker
    @Override
