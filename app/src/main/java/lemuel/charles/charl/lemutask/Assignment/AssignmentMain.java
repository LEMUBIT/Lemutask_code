...
public class AssignmentMain extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent ad = new Intent(AssignmentMain.this, AssignmentAddInput.class);
                startActivity(ad);
            }
        });
