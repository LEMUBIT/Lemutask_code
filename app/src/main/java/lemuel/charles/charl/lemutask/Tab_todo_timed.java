...
// Query for items from the database and get a cursor back
        Cursor todoCursor = sqlh.getTODOdata(pday,pmonth,pyear);//pmonth is incremented because in the sql helper class it is not incremented, unlike the function 'getcurrentdayTask()'
